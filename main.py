...
def get_user_move(yourturn):
    # if yourturn is not None:
    #     move_str = str(yourturn)
    # else:
    ...
    try:
        ...
        return get_user_move(yourturn)

# Returns a valid move based on the users input.
def get_valid_user_move(board, yourturn=None):
    while True:
        move = get_user_move(yourturn)
        valid = False
...
# while True:
#     move = get_valid_user_move(board, yourturn=None)
